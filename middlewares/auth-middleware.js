...
const User = require("../models/user") // 실제로 데이터베이스와 비교해야하니까 유저사용자모델이 필요함
...
module.exports = (req, res, next) => {
    ...
    // console.log(authorization); // Bearer sasojcopkvposb0poeortiqefjkdjbv0icxbjv0988745u3ri9gjf89vbuy34onvosdfjv834
